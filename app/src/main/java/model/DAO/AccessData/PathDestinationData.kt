...
class PathDestinationData {
    companion object {
        val destinations: Map<String, List<String>> = mapOf(
            ...
            "Carbon Blanc)" to listOf("BASSENS/CARBON BLANC", "La Gardette", ""),
            "Carbon Blanc) via CAT" to listOf("BASSENS/CARBON BLANC", "La Gardette", "via ESAT du GUA"),
            "Carbon Blanc) via CCBLAN" to listOf("BASSENS/CARBON BLANC", "La Gardette", "via Collège Simone Veil"),
            ...
            "Collège Aliénor d'Aquitaine via IMA" to listOf("MARTIGNAS SUR JALLE", "Collège Aliénor d'Aquitaine", "via IMA"),
            ...
            "Ecoparc (Descartes)" to listOf("BLANQUEFORT", "Ecoparc (Descartes)", ""),
            ...
            "Gambetta Mériadeck via IMA" to listOf("BORDEAUX", "Gambetta Mériadeck", "via IMA"),
            ...
            "La Belle Etoile via BERLIQ" to listOf("BOULIAC", "La Belle Étoile", "via Berliquet"),
            ...
            "Mérignac Phare via LYPEGU" to listOf("MERIGNAC", "Phare", "via Lycée Charles Peguy"),
